...
export const FORMAT_REGISTRY: Record<string, FormatDefinition> = {
  ...
  mp3: {
    ...
    targetFormats: ['mp3', 'wav', 'aac', 'ogg', 'flac', 'm4a', 'wma', 'opus', 'mp4', 'webm', 'zip'],
  ...
  wav: {
    ...
    targetFormats: ['wav', 'mp3', 'aac', 'ogg', 'flac', 'm4a', 'wma', 'opus', 'mp4', 'webm', 'mkv', 'avi', 'zip'],
    optionsSchema: { audioBitrate: true, audioChannels: true, audioSampleRate: true, audioVolume: true },
  },
  aac: {
    id: 'aac',
    ...
    targetFormats: ['mp3', 'wav', 'ogg', 'flac', 'm4a', 'opus', 'zip'],
  ...
  flac: {
    ...
    targetFormats: ['wav', 'mp3', 'aac', 'ogg', 'm4a', 'opus', 'zip'],
  ...
  ogg: {
    ...
    targetFormats: ['mp3', 'wav', 'aac', 'flac', 'm4a', 'opus', 'zip'],
    optionsSchema: { audioBitrate: true, audioChannels: true, audioSampleRate: true },
  },
  wma: {
    id: 'wma',
  ...
  m4a: {
    ...
    targetFormats: ['mp3', 'wav', 'aac', 'flac', 'ogg', 'opus', 'zip'],
    optionsSchema: { audioBitrate: true, audioChannels: true, audioSampleRate: true },
  },
  opus: {
    id: 'opus',
    ...
    targetFormats: ['mp3', 'wav', 'aac', 'ogg', 'flac', 'zip'],
    optionsSchema: { audioBitrate: true, audioChannels: true, audioSampleRate: true },
  },
  aiff: {
    id: 'aiff',
    ...
    targetFormats: ['mp3', 'wav', 'flac', 'aac', 'm4a', 'zip'],
    optionsSchema: { audioChannels: true, audioSampleRate: true },
  },
  aif: {
    id: 'aif',
  ...
  amr: {
    ...
    targetFormats: ['mp3', 'wav', 'aac', 'ogg', 'zip'],
  ...
  au: {
    ...
    targetFormats: ['wav', 'mp3', 'ogg', 'flac', 'zip'],
  ...
  caf: {
    ...
    targetFormats: ['wav', 'mp3', 'm4a', 'flac', 'zip'],
  },
  dts: {
    id: 'dts',
    name: 'DTS Audio',
  ...
  ac3: {
    ...
    targetFormats: ['mp3', 'wav', 'aac', 'flac', 'zip'],
    optionsSchema: { audioBitrate: true, audioChannels: true },
  },
  mka: {
    id: 'mka',
  ...
  mp4: {
    ...
    targetFormats: ['webm', 'mkv', 'avi', 'mov', 'mp3', 'wav', 'gif', 'zip'],
  ...
  webm: {
    ...
    targetFormats: ['mp4', 'mkv', 'avi', 'mov', 'mp3', 'wav', 'gif', 'zip'],
  ...
  mkv: {
    ...
    targetFormats: ['mp4', 'webm', 'avi', 'mov', 'mp3', 'wav', 'zip'],
  ...
  avi: {
    ...
    targetFormats: ['mp4', 'webm', 'mkv', 'mov', 'mp3', 'wav', 'zip'],
  ...
  mov: {
    ...
    targetFormats: ['mp4', 'webm', 'mkv', 'avi', 'mp3', 'wav', 'gif', 'zip'],
    optionsSchema: { videoResolution: true, videoCodec: true, videoFps: true },
  },
  wmv: {
    id: 'wmv',
    ...
    targetFormats: ['mp4', 'webm', 'mkv', 'avi', 'mp3', 'zip'],
  },
  flv: {
    id: 'flv',
    name: 'Flash Video',
    ...
    targetFormats: ['mp4', 'webm', 'mkv', 'mp3', 'zip'],
  },
  '3gp': {
    id: '3gp',
    ...
    targetFormats: ['mp4', 'webm', 'mp3', 'wav', 'zip'],
  },
  '3g2': {
    id: '3g2',
    name: '3GPP2 Video',
    ...
    targetFormats: ['mp4', 'webm', 'mp3', 'zip'],
  },
  ts: {
    id: 'ts',
    ...
    targetFormats: ['mp4', 'mkv', 'webm', 'mp3', 'zip'],
  },
  mts: {
    id: 'mts',
    name: 'AVCHD MTS',
  ...
  vob: {
    ...
    targetFormats: ['mp4', 'mkv', 'avi', 'mp3', 'zip'],
  },
  ogv: {
    id: 'ogv',
    name: 'Ogg Video',
  ...
  m4v: {
    ...
    targetFormats: ['mp4', 'webm', 'mkv', 'mov', 'zip'],
  },
  f4v: {
    id: 'f4v',
  ...
  mpg: {
    ...
    targetFormats: ['mp4', 'webm', 'mkv', 'avi', 'zip'],
  },
  mpeg: {
    id: 'mpeg',
    name: 'MPEG-1/MPEG-2',
  ...
  doc: {
    ...
    targetFormats: ['docx', 'pdf', 'txt', 'html', 'md', 'zip'],
  },
  docm: {
    id: 'docm',
    ...
    targetFormats: ['docx', 'pdf', 'html', 'txt', 'zip'],
  },
  dotx: {
    id: 'dotx',
  ...
  dot: {
    ...
    targetFormats: ['docx', 'pdf', 'txt', 'zip'],
  },
  rtf: {
    id: 'rtf',
    ...
    targetFormats: ['docx', 'pdf', 'html', 'txt', 'md', 'zip'],
  ...
  txt: {
    ...
    targetFormats: ['pdf', 'docx', 'html', 'md', 'epub', 'pptx', 'zip'],
  ...
  html: {
    ...
    targetFormats: ['pdf', 'docx', 'txt', 'md', 'epub', 'zip'],
  ...
  pages: {
    ...
    targetFormats: ['docx', 'pdf', 'txt', 'html', 'zip'],
  },
  wpd: {
    id: 'wpd',
  ...
  rst: {
    ...
    targetFormats: ['html', 'md', 'pdf', 'docx', 'txt', 'zip'],
  },
  tex: {
    id: 'tex',
    name: 'LaTeX Source',
  ...
  pdb: {
    ...
    targetFormats: ['txt', 'pdf', 'epub', 'zip'],
  },
  pdfa: {
    id: 'pdfa',
    name: 'PDF/A Archival',
  ...
  epub: {
    ...
    targetFormats: ['pdf', 'mobi', 'docx', 'txt', 'html', 'azw3', 'zip'],
  ...
  mobi: {
    ...
    targetFormats: ['epub', 'pdf', 'txt', 'azw3', 'docx', 'zip'],
  },
  azw: {
    id: 'azw',
    ...
    targetFormats: ['epub', 'pdf', 'mobi', 'txt', 'zip'],
  },
  azw3: {
    id: 'azw3',
    ...
    targetFormats: ['epub', 'pdf', 'mobi', 'txt', 'docx', 'zip'],
  },
  fb2: {
    id: 'fb2',
    ...
    targetFormats: ['epub', 'mobi', 'pdf', 'txt', 'docx', 'zip'],
  },
  ibooks: {
    id: 'ibooks',
  ...
  lit: {
    ...
    targetFormats: ['epub', 'pdf', 'txt', 'mobi', 'zip'],
  },
  lrf: {
    id: 'lrf',
  ...
  prc: {
    ...
    targetFormats: ['epub', 'mobi', 'pdf', 'txt', 'zip'],
  },
  rb: {
    id: 'rb',
    name: 'Rocket eBook',
  ...
  chm: {
    ...
    targetFormats: ['pdf', 'html', 'epub', 'txt', 'zip'],
  },
  djv: {
    id: 'djv',
  ...
  xlsm: {
    ...
    targetFormats: ['xlsx', 'csv', 'pdf', 'json', 'zip'],
  },
  xltx: {
    id: 'xltx',
  ...
  numbers: {
    ...
    targetFormats: ['xlsx', 'csv', 'pdf', 'tsv', 'zip'],
  },
  sdc: {
    id: 'sdc',
  ...
  pptx: {
    ...
    targetFormats: ['pdf', 'html', 'odp', 'ppt', 'txt', 'zip'],
  ...
  gif: {
    ...
    targetFormats: ['png', 'webp', 'jpg', 'mp4', 'pdf', 'zip'],
  ...
  heic: {
    ...
    targetFormats: ['jpg', 'png', 'webp', 'pdf', 'zip'],
  ...
  psd: {
    ...
    targetFormats: ['png', 'jpg', 'webp', 'pdf', 'tiff', 'zip'],
  },
  psb: {
    id: 'psb',
    ...
    targetFormats: ['png', 'jpg', 'tiff', 'pdf', 'zip'],
  },
  raw: {
    id: 'raw',
    ...
    targetFormats: ['jpg', 'png', 'tiff', 'dng', 'zip'],
  },
  cr2: {
    id: 'cr2',
    ...
    targetFormats: ['jpg', 'png', 'tiff', 'pdf', 'zip'],
  },
  cr3: {
    id: 'cr3',
  ...
  orf: {
    ...
    targetFormats: ['jpg', 'png', 'tiff', 'zip'],
  },
  rw2: {
    id: 'rw2',
  ...
  ai: {
    ...
    targetFormats: ['svg', 'pdf', 'png', 'jpg', 'zip'],
  },
  eps: {
    id: 'eps',
    ...
    targetFormats: ['pdf', 'svg', 'png', 'jpg', 'zip'],
  },
  tga: {
    id: 'tga',
    name: 'Truevision TGA',
    ...
    targetFormats: ['png', 'jpg', 'webp', 'bmp', 'zip'],
  },
  pcx: {
    id: 'pcx',
  ...
  jfif: {
    ...
    targetFormats: ['png', 'webp', 'pdf', 'zip'],
  },
  jp2: {
    id: 'jp2',
    name: 'JPEG 2000 (JP2)',
  ...
  otf: {
    ...
    targetFormats: ['woff', 'woff2', 'ttf', 'eot', 'zip'],
  },
  woff: {
    id: 'woff',
    ...
    targetFormats: ['woff2', 'ttf', 'otf', 'zip'],
  },
  woff2: {
    id: 'woff2',
    ...
    targetFormats: ['woff', 'ttf', 'otf', 'zip'],
  },
  eot: {
    id: 'eot',
  ...
  dwg: {
    ...
    targetFormats: ['dxf', 'pdf', 'svg', 'png', 'zip'],
  },
  dxf: {
    id: 'dxf',
    ...
    targetFormats: ['dwg', 'pdf', 'svg', 'png', 'zip'],
  },
  step: {
    id: 'step',
